...
def upload_cog_as_eeImgCol(dataPath, gs_dir, json_url, upload_flag=True, eeUser="omegazhangpzh"):
...
if __name__ == "__main__":
    ...
    upload_cog_as_eeImgCol(output_folder, gs_dir, json_url, upload_flag=True, eeUser="omegazhangpzh")
